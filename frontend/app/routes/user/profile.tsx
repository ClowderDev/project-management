...
const Profile = () => {
  const { data: userResponse, isPending } = useUserProfileQuery();
  const user = (userResponse as any)?.data as User;
              ...
              <div className="flex items-center space-x-4 mb-6">
                <Avatar className="h-20 w-20 bg-gray-600">
                  <AvatarImage
                    ...
                    alt={profileForm.watch("name") || user?.name}
                  />
                  <AvatarFallback className="text-xl">
                    {profileForm.watch("name")?.charAt(0) ||
                      user?.name?.charAt(0) ||
                      "U"}
                  </AvatarFallback>
                </Avatar>
